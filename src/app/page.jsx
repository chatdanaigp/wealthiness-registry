                ...
                <div className="max-w-lg w-full">
                    ...
                    <div className="glass rounded-3xl p-8 sm:p-12 text-center animate-fadeIn">
                        ...
                        <div className="flex justify-center mb-8">
                            <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-gold to-gold-light flex items-center justify-center gold-glow">
                        ...
                        <h1 className="text-3xl sm:text-4xl font-bold mb-4">
                            <span className="gold-gradient">Wealthiness</span>
                            <span className="text-white"> Registry</span>
                        </h1>

                        <p className="text-text-secondary text-lg mb-8">
                            ลงทะเบียนเพื่อรับสิทธิ์{" "}
                            <span className="text-gold font-semibold">7-Day VIP Access</span>
                            <br />
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8 text-left">
                            <div className="flex items-center gap-3 p-3 rounded-xl bg-black/30 border border-gold/10">
                        ...
                        <Link
                            href="/wn_registry"
                            className="btn-gold w-full py-4 text-lg group"
                        >
                    ...
                    {/* Bottom Glow */}
                    <div className="absolute -bottom-20 left-1/2 -translate-x-1/2 w-3/4 h-20 bg-gold/20 blur-3xl rounded-full"></div>
                </div>
            </div>
        </main>
    );
